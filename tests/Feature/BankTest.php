...
it('has a banks table', function () {
    expect(Schema::hasTable('banks'))->toBeTrue();
});

it('has a bank accounts table', function () {
    expect(Schema::hasTable('bank_accounts'))->toBeTrue();
});

it('has predefined banks data', function () {
    $banks = [
